...
import { ChevronRight, ArrowDown, Shield, Globe, Zap, Terminal, ExternalLink } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <a
            ...
            className="flex items-center gap-2 text-white/25 hover:text-white/60 transition-colors text-sm font-mono"
          >
